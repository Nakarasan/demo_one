        ...
        <div class="page-container">
            ...
            <div class="main-content">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="../db_action/fuel_edit_act.php" method="POST" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text"  name="fuel_type" value="<?php echo $data['fuel_type'] ?>" class="form-control" >
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="date"  name="last_update" value="<?php echo $data['last_update'] ?>" class="form-control">
                                                </div>
                                            </div>
                                    ...
                                    <a href='table.php'><button type="button" class="btn btn-danger">View</button>
