        ...
        <div class="page-container">
            ...
            <div class="main-content">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="../db_action/user_cre_act.php" method="POST" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text"  name="full_name" placeholder="Ex: John Cena" class="form-control" >
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text"  name="email" placeholder="Ex: kris******@gmail.com" class="form-control">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="number"  name="mobile_no" placeholder="Ex: 07X-XXX-XXXX" class="form-control">
                                                </div>
                                            </div>
