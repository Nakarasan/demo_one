        ...
        <div class="page-container">
            ...
            <div class="main-content">
                                    ...
                                    <div class="card-header">
                                        <strong>Fuel </strong>Create 
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="../db_action/fuel_cre_act.php" method="POST" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label  class=" form-control-label">Full Type</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text"  name="fuel_type" placeholder="" class="form-control" >
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="date"  name="last_update" placeholder="" class="form-control">
                                                </div>
                                            </div>
