...
if(isset($_POST['submit']) ) {
    ...
    $filename=$_POST['nic_pass'];
    $codeContents = 'mailto:'.$email.'?subject='.urlencode($nic_pass.$chassis_no.$fuel_type.$vehicle_no.$eli_week.$bal_week).'&body='.urlencode($email); 
                                        ...
                                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?> " method="POST">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <!--
                                                    ...
                                                    <button type="submit" name="create_qr" class="btn btn-secondary">Create QR</button> -->
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                     <input type="hidden" name="id" value="<?php echo $data['id'] ?>"><br><br> 
                                                     <input type="button" name="saveChanges" value="Save Changes" class="btn btn-success" > 
