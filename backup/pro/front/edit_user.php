        ...
        <div class="page-container">
            ...
            <div class="main-content">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="../db_action/user_edit_act.php" method="POST" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text"  name="user_name" value="<?php echo $data['user_name'] ?>" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="number"  name="mobile_no" value="<?php echo $data['mobile_no'] ?>" class="form-control">
                                                </div>
                                            </div>
