        ...
        <div class="page-container">
            ...
            <div class="main-content">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="../db_action/station_cre_act.php" method="POST" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text"  name="petrol_92" placeholder="" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text"  name="petrol_95" placeholder="" class="form-control">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text"  name="auto_diesel"  class="form-control">
                                                </div>
                                            </div>
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text"  name="super_diesel"  class="form-control">
                                                </div>
                                            </div>
